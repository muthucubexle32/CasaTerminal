...
const BookingForm: React.FC<BookingFormProps> = ({ equipment, onSubmit, onClose }) => {
  ...
  const calculateTotal = () => {
    const dailyRate = equipment.price.daily;
    return dailyRate * formData.days;
  };
    ...
    <div className="space-y-6">
          ...
          <div key={num} className="flex items-center flex-1">
            <div className="flex flex-col items-center flex-1">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold transition-all ${
                ...
                step === num ? 'bg-secondary-500 text-white scale-110 shadow-lg' :
                'bg-gray-200 text-gray-600'
              }`}>
                {step > num ? <Check className="w-4 h-4" /> : num}
              </div>
              <span className={`text-xs mt-1 ${
                step === num ? 'text-secondary-500 font-medium' : 'text-gray-500'
              }`}>
          ...
          >
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-secondary-500 ${
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-secondary-500"
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
              <p className="text-xs text-blue-700 flex items-center gap-1">
                ...
                Client ID: {formData.customerId} will be auto-generated
              </p>
            </div>
          </motion.div>
        )}
          ...
          >
            ...
            <div className="p-4 bg-primary-50 rounded-lg">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-secondary-500">{formData.days} days</span>
              </div>
              <div className="flex items-center justify-between text-sm mt-2">
                <span className="text-gray-600">Daily Rate:</span>
                <span className="font-medium text-secondary-500">
                  {equipment.price.currency}{equipment.price.daily.toLocaleString()}
                </span>
              </div>
              <div className="flex items-center justify-between font-semibold mt-3 pt-3 border-t border-gray-200">
                ...
                <span className="text-lg text-secondary-500">
                  {equipment.price.currency}{calculateTotal().toLocaleString()}
                </span>
              </div>
            </div>
          </motion.div>
        ...
        {step === 3 && (
          ...
          >
            <div className="space-y-3">
              <label className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-primary-50">
                <input
                  type="radio"
                  name="payment"
                  value="online"
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">Pay via UPI, Card, or NetBanking</p>
                </div>
              ...
              <label className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-primary-50">
                ...
                />
                <div className="flex-1">
                  <p className="font-medium text-gray-800 text-sm">Bank Transfer</p>
                  <p className="text-xs text-gray-500">Direct bank transfer within 24 hours</p>
                </div>
              ...
              <label className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-primary-50">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">Pay when equipment is delivered</p>
                </div>
            ...
            <div className="p-4 bg-yellow-50 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-yellow-700">
                  Security deposit of {equipment.price.currency}{equipment.price.daily * 2} required.
      ...
      <div className="flex justify-between pt-4 border-t border-gray-200">
        ...
        {step < 3 ? (
          <button
            onClick={handleNext}
            className="flex items-center gap-2 px-6 py-2 bg-secondary-500 text-white rounded-lg text-sm hover:bg-secondary-600"
          >
            Next
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2 bg-green-600 text-white rounded-lg text-sm hover:bg-green-700"
          >
...
const BookingDetailsModal: React.FC<BookingDetailsModalProps> = ({ booking, onClose, onUpdateStatus }) => {
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-1">Booking ID</label>
          <p className="text-sm font-medium text-secondary-500">{booking.id}</p>
        </div>
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-1">Status</label>
          <span className={`inline-block text-xs px-2 py-1 rounded-full ${getStatusColor(booking.status)}`}>
      ...
      <div>
        ...
        <p className="text-sm text-gray-900">{booking.equipmentName}</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-900">{booking.endDate}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-sm font-semibold text-secondary-500">₹{booking.totalAmount.toLocaleString()}</p>
        </div>
      </div>
      ...
      {booking.notes && (
        <div>
          ...
          <p className="text-sm text-gray-700 bg-gray-50 p-2 rounded-lg">{booking.notes}</p>
        </div>
      )}
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          placeholder="GPS, AC Cabin, Reverse Camera"
          className="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-secondary-500"
        />
      </div>
      ...
      <div>
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-secondary-500">
          <Camera className="w-8 h-8 text-gray-400 mx-auto mb-2" />
          <p className="text-sm text-gray-600">Click to upload photos</p>
          <p className="text-xs text-gray-500 mt-1">JPG, PNG up to 5MB (Max 5 photos)</p>
        </div>
      </div>
      ...
      <div className="flex justify-end gap-2 pt-4">
        ...
        <button
          type="submit"
          className="px-6 py-2 bg-secondary-500 text-white rounded-lg text-sm hover:bg-secondary-600"
        >
          Submit for Approval
        </button>
      </div>
...
const SettingsModal: React.FC<SettingsModalProps> = ({ onClose, onSave }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-semibold text-gray-700 mb-3">Business Address</h3>
        <textarea
...
const RentalDashboard = () => {
  ...
  const filteredBookings = bookings.filter(booking => {
    ...
    if (searchTerm && !booking.equipmentName.toLowerCase().includes(searchTerm.toLowerCase()) &&
  ...
  return (
    <div className="min-h-screen bg-primary-50">
        ...
        {showMobileMenu && (
          ...
          >
            <div className="p-4 border-b border-gray-200">
              <h2 className="font-bold text-secondary-500">Rental Dashboard</h2>
            </div>
            <nav className="p-2">
              {[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-secondary-500">Rental Dashboard</h1>
                <p className="text-xs sm:text-sm text-gray-600">Manage your equipment rentals</p>
              </div>
            </div>
          ...
          {/* Desktop Tabs */}
          <div className="hidden lg:flex items-center gap-1 mt-4">
            {[
              { id: 'overview', label: 'Overview', icon: LayoutDashboard },
              { id: 'listings', label: 'Listings', icon: Package },
              { id: 'bookings', label: 'Bookings', icon: Calendar },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="bg-white rounded-xl p-4 shadow-md">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-bold text-secondary-500">Active Rentals</h2>
                  <button
                    onClick={() => setActiveTab('bookings')}
                ...
                <div className="space-y-3">
                  {bookings.filter(b => b.status === 'active').map((booking) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between p-3 bg-primary-50 rounded-lg cursor-pointer"
                    >
                      <div>
                        <h3 className="font-medium text-secondary-500 text-sm">{booking.equipmentName}</h3>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-500 mt-1">{booking.days} days</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md">
                  <h3 className="text-sm font-semibold text-gray-700 mb-2">Utilization Rate</h3>
                  <div className="text-2xl font-bold text-secondary-500">{stats.utilizationRate}%</div>
                ...
                <div className="bg-white rounded-xl p-4 shadow-md">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="text-2xl font-bold text-secondary-500">{stats.averageRating}</div>
                    <Star className="w-5 h-5 fill-yellow-400 text-yellow-400" />
                  </div>
                  <p className="text-xs text-gray-600 mt-1">Based on {stats.completedRentals} rentals</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          {activeTab === 'bookings' && (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <h2 className="text-lg font-bold text-secondary-500">All Bookings</h2>
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1 sm:flex-none">
                    ...
                    <input
                      ...
                      className="pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-secondary-500 w-full sm:w-64"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-secondary-500"
                  >
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500">Booking ID</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500">Equipment</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {filteredBookings.map((booking) => (
                        <tr key={booking.id} className="hover:bg-gray-50">
                          <td className="px-4 py-3 text-sm font-medium text-secondary-500">{booking.id}</td>
                          <td className="px-4 py-3 text-sm text-gray-900">{booking.equipmentName}</td>
                          <td className="px-4 py-3 text-sm text-gray-900">{booking.customerName}</td>
                          <td className="px-4 py-3 text-sm text-gray-600">
                            {booking.startDate} to {booking.endDate}
                          </td>
                          <td className="px-4 py-3 text-sm font-medium text-secondary-500">
          ...
          {activeTab === 'listings' && (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <h2 className="text-lg font-bold text-secondary-500">My Listings</h2>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => setShowAddListing(true)}
                    className="flex items-center gap-2 px-4 py-2 bg-secondary-500 text-white rounded-lg text-sm hover:bg-secondary-600"
                  >
                  ...
                  >
                    <div className="relative h-32">
                      ...
                      <div className="absolute top-2 right-2">
                        <span className={`px-2 py-1 text-xs rounded-full ${
                          rental.available ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                        }`}>
                          {rental.available ? 'Available' : 'Out of Stock'}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-4">
                      <div className="flex items-start justify-between">
                        <div>
                          <h3 className="font-semibold text-secondary-500">{rental.name}</h3>
                          <p className="text-xs text-gray-600 mt-1">{rental.category} • {rental.subcategory}</p>
                        </div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-xs text-gray-500">({rental.reviews} reviews)</span>
                        <span className="text-xs text-gray-400">•</span>
                        <span className="text-xs text-gray-600">{rental.location}</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() => handleEditListing(rental.id)}
                            className="p-1 hover:bg-gray-100 rounded"
                          >
                            <Edit className="w-4 h-4 text-gray-600" />
                          </button>
                          <button
                            onClick={() => handleDeleteListing(rental.id)}
                            className="p-1 hover:bg-gray-100 rounded"
                          >
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-gray-600">Stock: {rental.stock} units</span>
                          <span className="text-gray-600">Condition: {rental.specifications.condition}</span>
                        </div>
                      </div>
                    </div>
                  </motion.div>
          ...
          {activeTab === 'earnings' && (
            <motion.div
              ...
              className="space-y-4"
            >
              <h2 className="text-lg font-bold text-secondary-500">Earnings Overview</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <p className="text-xs text-gray-500 mt-2">From {bookings.length} bookings</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <p className="text-xs text-gray-500 mt-2">{bookings.filter(b => b.paymentStatus === 'pending').length} pending</p>
                </div>
                ...
                <div className="space-y-3">
                  {bookings.slice(0, 5).map((booking) => (
                    <div key={booking.id} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                      <div>
                        <p className="text-sm font-medium text-gray-900">{booking.equipmentName}</p>
                        <p className="text-xs text-gray-500">{booking.customerName} • {booking.startDate}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm font-semibold text-secondary-500">₹{booking.totalAmount.toLocaleString()}</p>
                        <p className={`text-xs ${
      ...
      <Modal
        ...
        title={`New Booking: ${selectedEquipment?.name}`}
        size="lg"
      >
        {selectedEquipment && (
          <BookingForm
      ...
      <Modal
        ...
        title="Add New Equipment Listing"
        size="xl"
      >
        <AddListingModal
          onClose={() => setShowAddListing(false)}
      ...
      >
        <div className="space-y-3">
          {bookings.filter(b => b.status === 'pending').map((booking) => (
            <div key={booking.id} className="p-3 bg-yellow-50 rounded-lg">
              <div className="flex items-start justify-between mb-1">
                <h4 className="font-medium text-secondary-500 text-sm">New Booking Request</h4>
                <span className="text-xs text-gray-500">Now</span>
              </div>
              <p className="text-xs text-gray-600">
                {booking.equipmentName} - {booking.customerName}
              </p>
              <button
                onClick={() => {
                  setSelectedBooking(booking);
