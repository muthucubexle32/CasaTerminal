    ...
    <footer id="contact" className="bg-gradient-to-b from-[#502d13] to-[#3d220f] text-[#e9ddc8] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20 relative z-10">
        ...
        <div className="lg:hidden space-y-4 sm:space-y-6">
          ...
          >
            {/* Contact Methods */}
            <div className="bg-gradient-to-br from-[#e9ddc8]/10 to-[#e9ddc8]/5 
                  rounded-xl backdrop-blur-sm 
                  border border-[#e9ddc8]/10 
                  p-4">
              <h4 className="font-display font-bold text-base 
                   text-center mb-4 text-[#e9ddc8]">
                Quick Contact
              </h4>
                ...
                {contactInfo.map(({ Icon, text, href }) => (
                  <div key={text} className="flex items-center gap-3">
                    ...
                    {href ? (
                      <a
                        href={href}
                        className="text-sm text-[#e9ddc8]/80 
                         hover:text-[#e9ddc8] 
                      ...
                      <span className="text-sm text-[#e9ddc8]/80 
                             break-all flex-1 py-1">
                        {text}
                      </span>
                    )}
                  </div>
